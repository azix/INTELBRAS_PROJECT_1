    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meta_keywords', models.CharField(help_text=b'Comma-delimited set of SEO keywords for meta tag', max_length=255, verbose_name=b'Meta Keywords')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('categories', models.ManyToManyField(to='Testapp.Category')),
            ],
            options={
                'ordering': ['-created_at'],
                'db_table': 'products',
